...
command = f"python 3dface2idr_mat.py --in_root {args.indir}/epoch_20_000000"
print(command)
os.system(command)
# additional correction to match the submission version
command = f"python preprocess_cameras.py --source {args.indir}/epoch_20_000000 --mode orig"
print(command)
os.system(command)
...
Deep3DFaceRecon_pytorch\checkpoints\pretrained\results\vJK6TN6FAKg\epoch_20_000000